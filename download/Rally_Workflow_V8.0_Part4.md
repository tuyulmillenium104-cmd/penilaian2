...
================================================================================
                    SECTION 21: COMPLETE SKILL INTEGRATION CODE
================================================================================
...
class RallyWorkflowV8 {
  ...
  private calculateMarketEmotion(marketData: MarketData): MarketEmotion {
    ...
    // Factor in Fear & Greed Index if available
  ...
  async collectExternalData(
    ...
    // Generate search queries based on conditions
...
...`;
  ...
  // =========================================================================
  // PHASE 12: QUALITY SCORING (LLM PREDICTION)
  // =========================================================================
...
Output optimized content in same format.`;
    ...
    return content; // Simplified - would parse optimized content
  }
...
│  - Partial matching (contains check)                                        │
│  - Validated in: Phase 3 (hook generation) + Phase 12 (scoring)             │
│                                                                              │
│  PENALTY:                                                                   │
...
│  │ > 7.0     │ influencer_hunt │ Controversy spark  │ Change my mind   │    │
│  │           │                 │                    │ (not template!)  │    │
│  └─────────────────────────────────────────────────────────────────────┘    │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
...
================================================================================
                    SECTION 24: QUICK REFERENCE CARD
================================================================================
...
│  1.6: Market Context  │ FINANCE skill (NEW)                                 │
│  1.7: External Data   │ WEB-SEARCH + WEB-READER (NEW)                       │
│  2: Knowledge Base    │ Combine all data                                    │
│  3: Generation        │ LLM - NO TEMPLATES (NEW)                            │
│  4: Thread Structure  │ Validation                                          │
│  5: Invisible Influence│ Target keywords                                    │
│  6: Viral Mechanics   │ k-factor, share triggers                            │
│  7: Psych Triggers    │ 8 triggers                                          │
│  8: FR Strategy       │ Cheat code                                          │
│  9: Micro-Opt         │ Word choice, timing                                 │
│  10: Multi-Version    │ 3 alternatives                                      │
│  11: Benchmark        │ Compare to top 10                                   │
│  12: Quality Scoring  │ LLM prediction (NEW)                                │
│  13: Refinement       │ Loop max 3x                                         │
│  14: Pre-Submit       │ Final checklist                                     │
│  15: Final Review     │ Human approval                                      │
│  16: Submit           │ Post to Twitter + Rally                             │
│  17-21: Post-Submit   │ Track, refresh, analyze, learn, complete            │
│                                                                              │
│  SKILL USAGE:                                                               │
│  ────────────                                                                │
...
│  TIMING:                                                                    │
│  ────────────                                                                │
│  Peak: Wednesday 9 AM EST                                                   │
│  Crypto US: 9-11 AM EST                                                     │
│  Trend Jack: Within 30 min of event                                         │
│                                                                              │
│  LINK RULES:                                                                │
│  ────────────                                                                │
│  Non-Premium: Link in REPLY only                                            │
│  Premium: Link in Tweet 5+ or Reply                                         │
│  NEVER: Link in Tweet 1 (hook)                                              │
│                                                                              │
│  HASHTAG RULES:                                                             │
│  ────────────                                                                │
│  Maximum: 1-2 per thread                                                    │
│  NEVER: Hashtag in Tweet 1                                                  │
│  Location: End of Tweet 7                                                   │
│                                                                              │
│  FR CHEAT CODE:                                                             │
│  ────────────                                                                │
│  FR = log(Sum of Followers of Repliers + 1)                                 │
│  1 reply from 100K > 100 replies from 100                                   │
│  Reply bait required for FR > 6.0                                           │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
...
│  ENHANCED: 21 phases (up from 19)                                           │
│  ENHANCED: Scoring with LLM prediction                                      │
│                                                                              │

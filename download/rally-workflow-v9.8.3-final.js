 ...
 * ✅ ENHANCED G4 SCORING - With penalty tracking (+ sentence fragments)
 * ✅ VERIFICATION PROTOCOL - Mandatory claim verification before content
 * 
 ...
 * 
 * BASED ON: v9.8.3-final.js + Rally Master Guide V3 + V2
 * 
 * Usage:
 *   node rally-workflow-v9.8.4.js "Internet Court"
 *   node rally-workflow-v9.8.4.js 0xAF5a5B459F4371c1781E3B8456214CDD063EeBA7
 *   node rally-workflow-v9.8.4.js list
 */
...
const CONFIG = {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // NEW v9.8.4: PLATFORM AWARENESS - X (Twitter) Optimization
  // ═══════════════════════════════════════════════════════════════════════════
  platform: {
    name: 'X (Twitter)',
    style: {
      ...
      formatting: {
        shortParagraphs: '1-2 sentences max',
        lineBreaks: 'Use breaks for emphasis',
        hashtags: '1-3 relevant hashtags (if required)',
        mentions: 'Include required @mentions'
      },
      writingStyle: {
        contractions: 'Use naturally (don\'t, can\'t, it\'s)',
        sentenceFragments: 'Okay. Really. Works.',
        lowercase: 'casual i\'s and start some sentences lowercase',
        numbers: 'Use digits (47% not forty-seven percent)',
        punctuation: 'Straight quotes, hyphens instead of em dashes'
      },
      avoid: {
        aiPhrases: 'delve, leverage, realm, tapestry, paradigm, etc.',
        templateOpenings: 'Unpopular opinion, Hot take, Thread alert, etc.',
        formalLanguage: 'In conclusion, To summarize, Overall, etc.',
        emoji: 'Minimal emoji use, no emoji spam'
      }
    },
    context: {
      audience: 'Scroll quickly, need to be hooked instantly',
      competition: 'High noise, need to stand out',
      authenticity: 'Value real experiences over polished content'
    }
  },

  // ═══════════════════════════════════════════════════════════════════════════
  // ENHANCED v9.8.3: DIVERSIFIED HOOK OPENINGS - Structural Principles, Not Templates!
  // ═══════════════════════════════════════════════════════════════════════════
  hookVariations: {
    // PRINCIPLE-BASED HOOK TYPES - Competitor-Aware Selection
    // These are STRUCTURAL PRINCIPLES, NOT templates to copy!
    types: [
      {
        id: 'specific_moment',
        name: 'Specific Moment Hook',
        principle: 'Ground the reader in a specific time/place/situation',
        structure: {
          element1: 'Specific time reference (not vague like "recently")',
          element2: 'Specific situation or action',
          element3: 'Immediate emotional or physical detail'
        },
        howToCreate: 'Think of an exact moment when something happened. Use specifics: "Tuesday 3am" not "lately", "lost $47K" not "lost money"',
        avoidPattern: 'Generic time words: recently, a while back, the other day, lately',
        weight: 1.0
      },
      {
        id: 'shocking_claim',
        name: 'Shocking Claim Hook',
        principle: 'Make a bold statement that challenges or reveals',
        structure: {
          element1: 'Bold assertion or revelation',
          element2: 'Immediate curiosity gap',
          element3: 'Promise of proof/explanation'
        },
        howToCreate: 'What is the most surprising truth about this topic? State it directly without buildup.',
        avoidPattern: 'Clickbait phrases: "You won\'t believe", "Shocking truth about", "What they don\'t want you to know"',
        weight: 1.0
      },
      {
        id: 'relatable_struggle',
        name: 'Relatable Struggle Hook',
        principle: 'Connect through shared pain or frustration',
        structure: {
          element1: 'Specific struggle or obstacle',
          element2: 'Universal feeling or experience',
          element3: 'Vulnerability or honesty'
        },
        howToCreate: 'What frustrating experience do people in this space share? Describe the specific pain point without complaining.',
        avoidPattern: 'Whining tone or generic complaints: "I\'m so tired of", "Why does this always happen"',
        weight: 0.9
      },
      {
        id: 'contrarian_insight',
        name: 'Contrarian Insight Hook',
        principle: 'Challenge a common belief or assumption',
        structure: {
          element1: 'Reference to common belief',
          element2: 'Direct contradiction or nuance',
          element3: 'Hint of evidence'
        },
        howToCreate: 'What does everyone get wrong? What conventional wisdom is actually backwards? State the counter-intuitive truth.',
        avoidPattern: 'Cliche contrarian phrases: "Unpopular opinion", "Hot take", "Everyone\'s wrong"',
        weight: 0.85
      },
      {
        id: 'provocative_question',
        name: 'Provocative Question Hook',
        principle: 'Ask something that forces self-reflection',
        structure: {
          element1: 'Direct question to reader',
          element2: 'Personal stake or relevance',
          element3: 'Implicit promise of answer'
        },
        howToCreate: 'What question would make someone stop scrolling and think? Make it specific to their experience, not generic.',
        avoidPattern: 'Rhetorical questions: "Have you ever wondered?", "Did you know that?"',
        weight: 0.9
      },
      {
        id: 'casual_conversational',
        name: 'Casual Conversational Hook',
        principle: 'Write as if mid-conversation with a friend',
        structure: {
          element1: 'Conversational opener',
          element2: 'Immediate vulnerability or admission',
          element3: 'Natural voice, no formal structure'
        },
        howToCreate: 'How would you start telling this story to a friend at a bar? Skip the preamble, jump into the middle.',
        avoidPattern: 'SATURATED PATTERNS: "ngl", "tbh", "honestly", "fun story" - These are now AI markers!',
        warning: 'This hook type is HEAVILY SATURATED and detected as AI-generated. Use ONLY if competitor analysis shows it\'s NOT common.',
        weight: 0.5  // Lowest weight - often overused and detected as AI
      }
    ],
    // Saturated hook patterns to detect in competitor content
    saturatedPatterns: [
      'ngl', 'tbh', 'honestly', 'fun story', 'okay so', 'look', 'real talk',
      'unpopular opinion', 'hot take', 'thread alert', 'breaking',
      'this is your sign', 'psa', 'reminder that', 'quick thread',
      'last week', 'the other day', 'recently i', 'a while back',
      'you won\'t believe', 'shocking truth', 'here\'s the thing'
    ],
    // Selection strategy
    selectionStrategy: {
      method: 'competitor-aware',
      priority: 'least_used',
      fallback: 'specific_moment',
      maxSameTypeInCompetitors: 3,
      principleNotTemplate: true  // IMPORTANT: Use principles, not copy examples
    }
  },

  // ═══════════════════════════════════════════════════════════════════════════
  // ENHANCED v9.8.3: G4 SCORING V2 - With Penalty Tracking
  // ═══════════════════════════════════════════════════════════════════════════
  g4ScoringV2: {
    baseScore: 1.0,
    maxScore: 2.0,
    ...
    // Bonuses (ADD to base)
    bonuses: {
      casualHookOpening: { weight: 0.15, check: 'first_3_words' },
      parentheticalAside: { weight: 0.15, patterns: ['(and this is embarrassing to admit)', '(just saying)', '(real talk)', '(not gonna lie)'] },
      contractions: { weight: 0.20, minCount: 3 },
      sentenceFragments: { weight: 0.15, description: 'Short. Punchy. Works.' },
      personalAngle: { weight: 0.20, patterns: ['i ', 'my ', 'me ', 'sat there', 'watched', 'spent'] },
      conversationalEnding: { weight: 0.15, check: 'last_20_words' }
    },
    
    // Penalties (SUBTRACT from score)
    penalties: {
      emDashes: { weight: -0.30, chars: ['\u2014', '\u2013', '\u2015'] }, // — – ―
      smartQuotes: { weight: -0.20, chars: ['\u201c', '\u201d', '\u2018', '\u2019'] }, // " " ' '
      aiPhrases: { weight: -0.20, perOccurrence: true, maxPenalty: -0.60 },
      genericOpening: { weight: -0.30, patterns: ['in the world of', 'in todays', 'in the digital'] },
      formalEnding: { weight: -0.20, patterns: ['in conclusion', 'to summarize', 'overall'] },
      templateOpening: { weight: -0.40, patterns: ['unpopular opinion', 'hot take', 'thread alert'] },
      saturatedHook: { weight: -0.25, description: 'Hook pattern detected as saturated in competitors' }
    },
    ...
    requirementsForMax: {
      minBonus: 0.8,
      maxPenalty: 0,
      mustHave: ['casualHookOpening OR alternativeHook', 'personalAngle', 'contractions'],
      mustNotHave: ['emDashes', 'smartQuotes', 'aiPhrases']
    }
  },

  // ═══════════════════════════════════════════════════════════════════════════
  // NEW v9.8.4: VERIFICATION PROTOCOL - Mandatory before content
  // ═══════════════════════════════════════════════════════════════════════════
  verificationProtocol: {
    mandatory: true,
    steps: [
      { step: 1, action: 'Fetch campaign knowledgeBase', source: 'campaign API' },
      { step: 2, action: 'Research project website', source: 'web search' },
      { step: 3, action: 'Check project Twitter/X', source: 'web search' },
      { step: 4, action: 'Verify each specific claim', source: 'cross-reference' },
      { step: 5, action: 'Document sources', source: 'internal' }
    ],
    claimTypes: ['date', 'number', 'feature', 'name', 'comparison', 'partnership', 'token'],
    actionsIfUnverified: {
      optionA: 'Remove the claim',
      optionB: 'Use general/vague language',
      optionC: 'Ask user for confirmation',
      never: 'NEVER assume or fabricate information'
    },
    redFlags: [
      'Specific dates (launched yesterday, coming next week)',
      'Specific numbers (TVL, users, volume)',
...
function selectHookType(competitorAnalysis, contentIndex = 0) {
  ...
  // Count saturated patterns in competitor content
  const patternCounts = {};
  let totalSaturatedPatterns = 0;
  ...
  saturatedPatterns.forEach(pattern => {
    ...
    competitorContent.forEach(content => {
      if (content && content.toLowerCase().includes(pattern.toLowerCase())) {
        ...
        totalSaturatedPatterns++;
      }
    });
  });
  
  // Calculate saturation score for each hook type based on principle matching
  // NOT based on example matching - we check if the PRINCIPLE is overused
  const hookTypeScores = {};
  
  hookTypes.forEach(hook => {
    // Base score from weight
    let score = hook.weight;
    let saturationCount = 0;
    
    // Check avoidPattern keywords in competitor content
    const avoidKeywords = hook.avoidPattern.toLowerCase().split(/[^a-z]+/).filter(w => w.length > 3);
    competitorContent.forEach(content => {
      if (content) {
    ...
    // Special check for casual_conversational - count ngl/tbh/honestly usage
    if (hook.id === 'casual_conversational') {
      const casualPatterns = ['ngl', 'tbh', 'honestly', 'fun story'];
      let casualCount = 0;
      competitorContent.forEach(content => {
        if (content) {
          casualPatterns.forEach(pattern => {
            if (content.toLowerCase().startsWith(pattern)) {
              casualCount++;
            }
          });
        }
      ...
      // If >30% use casual hooks, HEAVILY penalize
      if (casualCount > competitorContent.length * 0.3) {
        score *= 0.3; // Heavy penalty
        console.log(`   ⚠️ Casual hooks SATURATED (${casualCount}/${competitorContent.length} competitors) - score reduced`);
      }
    }
    
    // Penalize based on saturation
    const saturationRatio = saturationCount / Math.max(competitorContent.length, 1);
    score *= (1 - saturationRatio * 0.5); // Reduce score by up to 50% based on saturation
    
    hookTypeScores[hook.id] = { score, saturationCount, saturationRatio };
  });
  
  // Log saturation analysis
  console.log('   📊 Hook saturation analysis:');
  hookTypes.forEach(hook => {
    const s = hookTypeScores[hook.id];
    const status = s.saturationCount >= 3 ? '⚠️ SATURATED' : '✅ OK';
    console.log(`      ${hook.id}: ${s.saturationCount} matches, score ${s.score.toFixed(2)} ${status}`);
  });
  
  // Select hook with highest score
  ...
  hookTypes.forEach(hook => {
    ...
    // Skip if too saturated
    if (s.saturationCount >= selectionStrategy.maxSameTypeInCompetitors) {
      console.log(`   ⚠️ Hook "${hook.id}" too saturated - skipping`);
      return;
    }
    
    // Check warning
    if (hook.warning) {
      console.log(`   ⚠️ Warning for ${hook.id}: ${hook.warning.substring(0, 50)}...`);
    }
  ...
  // Fallback
  if (!selectedHook) {
    selectedHook = hookTypes.find(h => h.id === selectionStrategy.fallback);
    console.log('   🎣 All hooks saturated - using fallback: specific_moment');
  }
  
  console.log(`   🎣 Selected: ${selectedHook.name}`);
  console.log(`   📋 Principle: ${selectedHook.principle}`);
  console.log(`   🔧 How to create: ${selectedHook.howToCreate.substring(0, 60)}...`);
  
  return selectedHook;
}

/**
 * Count sentence fragments in content
 */
function countSentenceFragments(content) {
  if (!content) return 0;
  
  // Sentence fragments are short, punchy "sentences" that aren't complete
  // Examples: "Okay." "Really." "Works." "Cold sweat." "Real sweat."
  ...
  sentences.forEach(sentence => {
    ...
    // Fragments are usually 1-3 words, no subject-verb structure
    if (words <= 3 && trimmed.length > 0) {
      // Check if it's not a complete sentence (no subject-verb)
      const hasSubjectVerb = /^(I|you|we|they|he|she|it|this|that|there)\s+(am|is|are|was|were|have|has|do|does|did|will|would|can|could|should|may|might)/i.test(trimmed);
      if (!hasSubjectVerb) {
        fragmentCount++;
      }
    }
...
function detectG4Elements(content) {
  ...
  // NEW v9.8.4: 3.5. Sentence Fragments (casual effect)
  const fragmentCount = countSentenceFragments(content);
  const hasSentenceFragments = fragmentCount >= 2; // Need at least 2 fragments
  result.bonuses.sentenceFragments = { count: fragmentCount, passed: hasSentenceFragments };
  if (hasSentenceFragments) {
    result.totalBonus += 0.15; // weight from g4ScoringV2
  } else if (fragmentCount === 0) {
    result.recommendations.push('Add sentence fragments for casual effect (e.g., "Okay. Really. Works.")');
  }
...
async function generateUniqueContent(llm, campaignData, competitorAnalysis, researchData, tweetCount = 1, contentIndex = 0) {
  ...
  const systemPrompt = `You are an ELITE content creator who writes viral, authentic content for ${platform.name}.

═══════════════════════════════════════════════════════════════════════════════
🎯 PLATFORM CONTEXT: ${platform.name}
═══════════════════════════════════════════════════════════════════════════════

Your content will be posted on X (Twitter). Write accordingly:
- Tone: ${platform.style.tone}
- Paragraphs: ${platform.style.formatting.shortParagraphs}
- Use line breaks for emphasis
- Natural contractions: ${platform.style.writingStyle.contractions}
- Sentence fragments work well: ${platform.style.writingStyle.sentenceFragments}
- Use digits for numbers: ${platform.style.writingStyle.numbers}
- Straight quotes only, hyphens instead of em dashes

Audience behavior: ${platform.context.audience}
...
═══════════════════════════════════════════════════════════════════════════════
🎣 HOOK SELECTION (COMPETITOR-AWARE - PRINCIPLE BASED)
═══════════════════════════════════════════════════════════════════════════════

Selected Hook Strategy: ${selectedHookType.name}

📋 PRINCIPLE: ${selectedHookType.principle}

🏗️ STRUCTURE TO FOLLOW:
${Object.entries(selectedHookType.structure).map(([key, val]) => `   • ${key}: ${val}`).join('\n')}

🔧 HOW TO CREATE YOUR HOOK:
${selectedHookType.howToCreate}

⚠️ PATTERNS TO AVOID (will make you sound AI-generated):
${selectedHookType.avoidPattern}
${selectedHookType.warning ? '\n🚨 WARNING: ' + selectedHookType.warning : ''}

═══════════════════════════════════════════════════════════════════════════════
🎯 CRITICAL: Apply the PRINCIPLE, do NOT copy templates!
═══════════════════════════════════════════════════════════════════════════════

Your hook must be ORIGINAL. Use the STRUCTURE above as your guide, but create
something unique that fits the campaign. Do NOT use any of the example phrases
you've seen - those are already used by competitors.

📌 1. HOOK - The Opening Line (Apply the PRINCIPLE above!)
────────────────────────────────────
Your hook is CRITICAL. It determines if people stop scrolling.

APPLY THE SELECTED HOOK PRINCIPLE - Create something ORIGINAL that:
- Follows the structure elements
- Avoids the patterns marked as "saturated"
- Feels like a REAL person talking, not a template

❌ TERRIBLE HOOKS (NEVER use these - they are AI markers):
• "Unpopular opinion:" / "Hot take:" / "Thread alert:"
• "Here's the thing:" / "Let me tell you a story:"
• "I've been thinking about..." / "Nobody is talking about..."
• "Stop scrolling:" / "This changed everything:" / "Quick thread:"
• "ngl" / "tbh" / "honestly" (SATURATED - now AI markers!)
